...
def view_home(request):
    ...
    return render(request, 'templates/pages/home.html', {'gastos_total': total_gastos,'gastos': gastos, 'jubilacion': jubilacion_int, 'restante': jubilacion_restante})
...
def view_home2(request, mes):
    ...
    return render(request, 'templates/pages/home2.html', {'gastos_total': total_gastos_mes ,'gastos': gastos_mes, 'jubilacion': jubilacion, 'restante': restante, 'jub_mes':jubilacion_int, 'gasto_mes':mes})
